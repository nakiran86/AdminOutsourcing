            ...
            <table class="toolbar">
                <tbody>
                    <tr>
                        ...
                        <?php } if ($this->grant->check_privilege('MOD_ADMINOUTSOURCING', 'delete') && in_array($this->item['status'], array('PENDING', 'CANCELING'))) { ?>
                        <td align="center">
                        ...
                        <?php } if ($this->grant->check_privilege('MOD_ADMINOUTSOURCING', 'admin') && in_array('MANAGER', Session::get('group')) && $this->item['status'] == 'CANCELING') { ?>
                        <td align="center">
                        ...
                        <?php } if ($this->grant->check_privilege('MOD_ADMINOUTSOURCING', 'approved') && $this->item['status'] == 'PENDING') { ?>
                        <td align="center">
                        ...
                        <?php } if ($this->grant->check_privilege('MOD_ADMINOUTSOURCING', 'edit') && $this->item['status'] == 'PENDING') { ?>
                        <td align="center">
                        ...
                        <?php } if ($this->grant->check_privilege('MOD_ADMINOUTSOURCING', 'edit') && in_array($this->item['status'], array('PENDING', 'APPROVED'))) { ?>
                        <td align="center">
                        ...
                        <?php } if ($this->grant->check_privilege('MOD_ADMINOUTSOURCING', 'approved') && in_array($this->item['status'], array('PENDING', 'FINISHED'))) { ?>
                        <td align="center">
            ...
            <div id="tabs">
                            ...
                            <tr>
                                <td colspan="2" style="padding:0">
                                    <table cellspacing="0" border="1" class="adminlist stockout">
                                        ...
                                        <tbody id="list">
                                            <?php $i=1; foreach ($this->proList as $outSourcePro) { ?>
                                            <tr id="rows<?php echo $i;?>" class="<?php echo ($i % 2 == 1 ? 'row0' : 'row1') . ' ' . ($outSourcePro['quantity'] == $outSourcePro['quantity_import'] ? ' finished' : ''); ?>">
                                                <td width="15" align="center"><div id="no<?php echo $i;?>"><a href="javascript:void(0);" onclick="showHideMaterial('<?php echo $i;?>', 'show');" title="{{.show_material.}}"><span class="icon-button-16 Icon-16-Expand" title="{{.show_material.}}"></span></a></div></td>
                                                ...
                                                <td colspan="8">
                                                    <table cellspacing="0" border="1" class="adminlist">
                                                        ...
                                                        <tbody id="list_material_<?php echo $outSourcePro['id']; ?>">
                                                            <?php $j=1; foreach ($this->proMaterialList as $keM => $veM) { ?>
                ...
                <div id="general-details">
                    ...
                    <table cellspacing="0" border="1" class="adminlist">
                        ...
                        <tbody id="list">
                            <?php $k = 1; foreach ($this->itemsGeneral as $index => $itemsGeneral) { ?>
